...
public interface WordRelWordsService extends IService<WordRelWords> {
     ...
     */
    List<WordRelWords> getWordRelWordsByWordId(Integer wordId);
     ...
     * @return 该表的除表主键 id 和单词 id 外的数据列表
     */
    List<WordRelWords> getWordRelWordsByWord(String word);
